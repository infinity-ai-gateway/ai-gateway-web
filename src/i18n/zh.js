...
export default {
  ...
  entity: {
    ...
    nameRule:
      '1–64 字符；仅小写字母、数字、_、-；不能以 _ 或 - 开头/结尾',
    nameFormatError:
  ...
  provider: {
    ...
    modelList: '模型列表',
    syncModels: '获取',
    modelsHintDiscoverOnly: '点击「获取」从上游拉取模型列表',
    modelsListTip:
    ...
    syncModelsConfirm: '将用上游返回的模型列表覆盖当前表单中的模型列表，仍需点击提交才会保存。',
  ...
  modelPrices: {
    ...
    priceItemValuePlaceholder: '请输入价格',
    tierPriceObject: '分时段价格',
    tierObject: '时段对象',
    tierPriceTip: '分时段价格配置专属的价格；不在这些时段内时将使用默认价格，可选填。',
