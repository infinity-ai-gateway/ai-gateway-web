    ...
    buttons: [
      {
        ...
        example: `${i18n.t(
          'route.tipExpression',
        )}<br/><br/><p>req_path_in("/post", false)</p>`,
      },
      {
        name: 'prefix_in',
        ...
        example: `${i18n.t(
          'route.tipExpression',
        )}<br/><br/><p>req_path_prefix_in("/report/", true)</p>`,
      },
      {
        name: 'suffix_in',
        ...
        example: `${i18n.t(
          'route.tipExpression',
        )}<br/><br/><p>req_path_suffix_in("post", false)</p>`,
      },
    ],
  },
  {
    ...
    buttons: [
      ...
      },
      {
        ...
        example: `${i18n.t(
          'route.tipExpression',
        )}<br/><br/><p>req_query_value_in("search", "flower", false)</p>`,
      },
      {
        ...
        example: `${i18n.t(
          'route.tipExpression',
        )}<br/><br/><p>req_query_value_prefix_in("search", "flow", false)</p>`,
      },
      {
        ...
        example: `${i18n.t(
          'route.tipExpression',
        )}<br/><br/><p>req_query_value_suffix_in("search", "er", false)</p>`,
      },
      {
        name: 'value_hash_in',
        ...
        example: `${i18n.t(
          'route.tipExpression',
        )}<br/><br/><p>req_query_value_hash_in("search", "0-100|1000-1100|9999", false)</p>`,
      },
    ],
  },
  {
    ...
    buttons: [
      ...
      },
      {
        ...
        example: `${i18n.t(
          'route.tipExpression',
        )}<br/><br/><p>req_cookie_value_in("ssp-web-version", "v0", true)</p>`,
      },
      {
        name: 'value_prefix_in',
        description:
        ...
        example: `${i18n.t(
          'route.tipExpression',
        )}<br/><br/><p>req_cookie_value_prefix_in("RE_SERVER_ID", "171593627", false)`,
      },
      {
        name: 'value_suffix_in',
        description:
        ...
        example: `${i18n.t(
          'route.tipExpression',
        )}<br/><br/><p>req_cookie_value_suffix_in("RE_SERVER_ID", "171593627", false)</p>`,
      },
      {
        name: 'value_hash_in',
        description:
  ...
  },
  {
    ...
    buttons: [
      ...
      },
      {
        ...
        example: `${i18n.t(
          'route.tipExpression',
        )}<br/><br/><p>req_header_value_in("game-bfe-dev", "1", true)</p>`,
      },
      {
        name: 'value_prefix_in',
        description:
        ...
        example: `${i18n.t(
          'route.tipExpression',
        )}<br/><br/><p>req_header_value_prefix_in("game", "1", true)</p>`,
      },
      {
        name: 'value_suffix_in',
        description:
        ...
        example: `${i18n.t(
          'route.tipExpression',
        )}<br/><br/><p>req_header_value_suffix_in("dev", "1", true)</p>`,
      },
      {
        name: 'value_hash_in',
        description:
          'req_header_value_hash_in(key, patterns, case_insensitive)',
  ...
  },
  {
    ...
    buttons: [
      ...
      },
      {
        ...
        description: 'req_body_json_prefix_in(model, prefix, foldCase)',
        expression: 'req_body_json_prefix_in("","",false)',
        example:
